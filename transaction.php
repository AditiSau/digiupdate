...
body {
  ...
  width: 70%;
  margin: 2% 13%;
  background-image:linear-gradient(white,pink,crimson);
}
...
<body>
 <div class="col-50">
            <h1>Payment For 1 year Ad free Experience</h1>
               <h3>Pay only 349/- and get 1 year Subscription</h3>
          ...
          <a type="submit" href="home2.php"class="btn btn-primary btn-lg w-100" name="sub" id ="">Pay </a>
